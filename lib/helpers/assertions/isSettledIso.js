 ...
 *  @deprecated
 */
function isSettledIso(contender) {
    void contender;
    // return isSettledRight<T>(contender) || isSettledLeft(contender);
    throw new SyntaxError('usage of isSettledIso(<contender>) has been deprecated in favor of isSettled(<contender>)');
}
exports.isSettledIso = isSettledIso;
//# sourceMappingURL=isSettledIso.js.map